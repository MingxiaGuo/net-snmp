...
XS_EUPXS(XS_NetSNMP__ASN_constant); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_NetSNMP__ASN_constant)
{
    dVAR; dXSARGS;
    if (items != 1)
...
extern "C"
#endif
XS_EXTERNAL(boot_NetSNMP__ASN); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_NetSNMP__ASN)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        (void)newXSproto_portable("NetSNMP::ASN::constant", XS_NetSNMP__ASN_constant, file, "$");
#if PERL_VERSION_LE(5, 21, 5)
