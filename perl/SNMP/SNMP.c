...
XS_EUPXS(XS_SNMP_constant); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP_constant)
{
    dVAR; dXSARGS;
    if (items != 2)
...
XS_EUPXS(XS_SNMP__sys_uptime); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__sys_uptime)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_SNMP_init_snmp); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP_init_snmp)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "appname");
    {
...
XS_EUPXS(XS_SNMP__api_mode); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__api_mode)
{
    dVAR; dXSARGS;
    if (items < 0 || items > 1)
       croak_xs_usage(cv,  "mode=0");
    {
	int	mode;
	int	RETVAL;
	dXSTARG;
...
XS_EUPXS(XS_SNMP__new_session); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__new_session)
{
    dVAR; dXSARGS;
    if (items != 6)
       croak_xs_usage(cv,  "version, community, peer, lport, retries, timeout");
    {
...
#line 2824 "SNMP.c"
	{
	    ...
	    sv_setref_pv(RETVALSV, "SnmpSessionPtr", (void*)RETVAL);
	    ST(0) = RETVALSV;
	}
    }
    XSRETURN(1);
...
XS_EUPXS(XS_SNMP__new_v3_session); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__new_v3_session)
{
    dVAR; dXSARGS;
    if (items != 23)
       croak_xs_usage(cv,  "version, peer, retries, timeout, sec_name, sec_level, sec_eng_id, context_eng_id, context, auth_proto, auth_pass, priv_proto, priv_pass, eng_boots, eng_time, auth_master_key, auth_master_key_len, priv_master_key, priv_master_key_len, auth_localized_key, auth_localized_key_len, priv_localized_key, priv_localized_key_len");
    {
...
XS_EUPXS(XS_SNMP__new_tunneled_session); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__new_tunneled_session)
{
    dVAR; dXSARGS;
    if (items != 12)
       croak_xs_usage(cv,  "version, peer, retries, timeout, sec_name, sec_level, context_eng_id, context, our_identity, their_identity, their_hostname, trust_cert");
    {
	int	version = (int)SvIV(ST(0))
;
	char *	peer = (char *)SvPV_nolen(ST(1))
...
;
	int	sec_level = (int)SvIV(ST(5))
;
	char *	context_eng_id = (char *)SvPV_nolen(ST(6))
;
	char *	context = (char *)SvPV_nolen(ST(7))
;
	char *	our_identity = (char *)SvPV_nolen(ST(8))
;
	char *	their_identity = (char *)SvPV_nolen(ST(9))
;
	char *	their_hostname = (char *)SvPV_nolen(ST(10))
;
	char *	trust_cert = (char *)SvPV_nolen(ST(11))
;
	SnmpSession *	RETVAL;
#line 2803 "SNMP.xs"
	{
...
XS_EUPXS(XS_SNMP__update_session); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__update_session)
{
    dVAR; dXSARGS;
    if (items != 7)
       croak_xs_usage(cv,  "sess_ref, version, community, peer, lport, retries, timeout");
    {
	SV *	sess_ref = ST(0)
;
...
XS_EUPXS(XS_SNMP__add_mib_dir); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__add_mib_dir)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "mib_dir, force=0");
    {
...
XS_EUPXS(XS_SNMP__init_mib_internals); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__init_mib_internals)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_SNMP__getenv); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__getenv)
{
    dVAR; dXSARGS;
    if (items != 1)
...
XS_EUPXS(XS_SNMP__setenv); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__setenv)
{
    dVAR; dXSARGS;
    if (items != 3)
       croak_xs_usage(cv,  "envname, envval, overwrite");
    {
	char *	envname = (char *)SvPV_nolen(ST(0))
;
	char *	envval = (char *)SvPV_nolen(ST(1))
;
	int	overwrite = (int)SvIV(ST(2))
;
	int	RETVAL;
	dXSTARG;
#line 2983 "SNMP.xs"
...
XS_EUPXS(XS_SNMP__read_mib); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__read_mib)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "mib_file, force=0");
    {
...
XS_EUPXS(XS_SNMP__read_module); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__read_module)
{
    dVAR; dXSARGS;
    if (items != 1)
...
XS_EUPXS(XS_SNMP__set); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__set)
{
    dVAR; dXSARGS;
    if (items != 3)
       croak_xs_usage(cv,  "sess_ref, varlist_ref, perl_callback");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	SV *	sess_ref = ST(0)
...
XS_EUPXS(XS_SNMP__catch); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__catch)
{
    dVAR; dXSARGS;
    if (items != 2)
       croak_xs_usage(cv,  "sess_ref, perl_callback");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	SV *	sess_ref = ST(0)
...
XS_EUPXS(XS_SNMP__get); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__get)
{
    dVAR; dXSARGS;
    if (items != 4)
       croak_xs_usage(cv,  "sess_ref, retry_nosuch, varlist_ref, perl_callback");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	SV *	sess_ref = ST(0)
...
XS_EUPXS(XS_SNMP__getnext); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__getnext)
{
    dVAR; dXSARGS;
    if (items != 3)
       croak_xs_usage(cv,  "sess_ref, varlist_ref, perl_callback");
...
XS_EUPXS(XS_SNMP__getbulk); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__getbulk)
{
    dVAR; dXSARGS;
    if (items != 5)
       croak_xs_usage(cv,  "sess_ref, nonrepeaters, maxrepetitions, varlist_ref, perl_callback");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	SV *	sess_ref = ST(0)
...
XS_EUPXS(XS_SNMP__bulkwalk); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__bulkwalk)
{
    dVAR; dXSARGS;
    if (items != 5)
       croak_xs_usage(cv,  "sess_ref, nonrepeaters, maxrepetitions, varlist_ref, perl_callback");
...
XS_EUPXS(XS_SNMP__trapV1); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__trapV1)
{
    dVAR; dXSARGS;
    if (items != 7)
       croak_xs_usage(cv,  "sess_ref, enterprise, agent, generic, specific, uptime, varlist_ref");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	SV *	sess_ref = ST(0)
...
XS_EUPXS(XS_SNMP__trapV2); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__trapV2)
{
    dVAR; dXSARGS;
    if (items != 4)
       croak_xs_usage(cv,  "sess_ref, uptime, trap_oid, varlist_ref");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	SV *	sess_ref = ST(0)
...
XS_EUPXS(XS_SNMP__inform); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__inform)
{
    dVAR; dXSARGS;
    if (items != 5)
       croak_xs_usage(cv,  "sess_ref, uptime, trap_oid, varlist_ref, perl_callback");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	SV *	sess_ref = ST(0)
...
XS_EUPXS(XS_SNMP__get_type); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__get_type)
{
    dVAR; dXSARGS;
    if (items != 2)
       croak_xs_usage(cv,  "tag, best_guess");
    {
...
XS_EUPXS(XS_SNMP__dump_packet); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__dump_packet)
{
    dVAR; dXSARGS;
    if (items != 1)
...
XS_EUPXS(XS_SNMP__map_enum); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__map_enum)
{
    dVAR; dXSARGS;
    if (items != 4)
       croak_xs_usage(cv,  "tag, val, iflag, best_guess");
    {
	char *	tag = (char *)SvPV_nolen(ST(0))
;
...
XS_EUPXS(XS_SNMP__translate_obj); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__translate_obj)
{
    dVAR; dXSARGS;
    if (items != 6)
       croak_xs_usage(cv,  "var, mode, use_long, auto_init, best_guess, include_module_name");
    {
...
XS_EUPXS(XS_SNMP__set_replace_newer); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__set_replace_newer)
{
    dVAR; dXSARGS;
    if (items != 1)
...
XS_EUPXS(XS_SNMP__set_save_descriptions); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__set_save_descriptions)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "val");
...
XS_EUPXS(XS_SNMP__set_debugging); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__set_debugging)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "val");
...
XS_EUPXS(XS_SNMP__register_debug_tokens); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__register_debug_tokens)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "tokens");
    {
	char *	tokens = (char *)SvPV_nolen(ST(0))
;
#line 4929 "SNMP.xs"
	{
...
XS_EUPXS(XS_SNMP__debug_internals); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__debug_internals)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "val");
...
XS_EUPXS(XS_SNMP__mib_toggle_options); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__mib_toggle_options)
{
    dVAR; dXSARGS;
    if (items != 1)
...
XS_EUPXS(XS_SNMP__sock_cleanup); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__sock_cleanup)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_SNMP__mainloop_finish); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__mainloop_finish)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_SNMP__main_loop); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__main_loop)
{
    dVAR; dXSARGS;
    if (items < 3 || items > 4)
       croak_xs_usage(cv,  "timeout_sec, timeout_usec, perl_callback, ss=(SnmpSession*)NULL");
    {
...
;
	...
	if (items < 4)
	    ...
	    if (SvROK(ST(3)) && sv_derived_from(ST(3), "SnmpSessionPtr")) {
...
XS_EUPXS(XS_SNMP__get_select_info); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__get_select_info)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_SNMP__read_on_fd); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__read_on_fd)
{
    dVAR; dXSARGS;
    if (items != 1)
...
XS_EUPXS(XS_SNMP__check_timeout); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__check_timeout)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_SNMP__MIB__NODE_TIEHASH); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__MIB__NODE_TIEHASH)
{
    dVAR; dXSARGS;
    if (items < 2 || items > 3)
       croak_xs_usage(cv,  "cl, key, tp=0");
    {
...
XS_EUPXS(XS_SNMP__MIB__NODE_FETCH); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SNMP__MIB__NODE_FETCH)
{
    dVAR; dXSARGS;
    if (items != 2)
       croak_xs_usage(cv,  "tp_ref, key");
    {
	SV *	tp_ref = ST(0)
;
	char *	key = (char *)SvPV_nolen(ST(1))
...
XS_EUPXS(XS_SnmpSessionPtr_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_SnmpSessionPtr_DESTROY)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "sess_ptr");
    {
...
extern "C"
#endif
XS_EXTERNAL(boot_SNMP); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_SNMP)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        newXS_deffile("SNMP::constant", XS_SNMP_constant);
        newXS_deffile("SNMP::_sys_uptime", XS_SNMP__sys_uptime);
        newXS_deffile("SNMP::init_snmp", XS_SNMP_init_snmp);
        newXS_deffile("SNMP::_api_mode", XS_SNMP__api_mode);
        newXS_deffile("SNMP::_new_session", XS_SNMP__new_session);
        newXS_deffile("SNMP::_new_v3_session", XS_SNMP__new_v3_session);
        newXS_deffile("SNMP::_new_tunneled_session", XS_SNMP__new_tunneled_session);
        newXS_deffile("SNMP::_update_session", XS_SNMP__update_session);
        newXS_deffile("SNMP::_add_mib_dir", XS_SNMP__add_mib_dir);
        newXS_deffile("SNMP::_init_mib_internals", XS_SNMP__init_mib_internals);
        newXS_deffile("SNMP::_getenv", XS_SNMP__getenv);
        newXS_deffile("SNMP::_setenv", XS_SNMP__setenv);
        newXS_deffile("SNMP::_read_mib", XS_SNMP__read_mib);
        newXS_deffile("SNMP::_read_module", XS_SNMP__read_module);
        newXS_deffile("SNMP::_set", XS_SNMP__set);
        newXS_deffile("SNMP::_catch", XS_SNMP__catch);
        newXS_deffile("SNMP::_get", XS_SNMP__get);
        newXS_deffile("SNMP::_getnext", XS_SNMP__getnext);
        newXS_deffile("SNMP::_getbulk", XS_SNMP__getbulk);
        newXS_deffile("SNMP::_bulkwalk", XS_SNMP__bulkwalk);
        newXS_deffile("SNMP::_trapV1", XS_SNMP__trapV1);
        newXS_deffile("SNMP::_trapV2", XS_SNMP__trapV2);
        newXS_deffile("SNMP::_inform", XS_SNMP__inform);
        newXS_deffile("SNMP::_get_type", XS_SNMP__get_type);
        newXS_deffile("SNMP::_dump_packet", XS_SNMP__dump_packet);
        newXS_deffile("SNMP::_map_enum", XS_SNMP__map_enum);
        newXS_deffile("SNMP::_translate_obj", XS_SNMP__translate_obj);
        newXS_deffile("SNMP::_set_replace_newer", XS_SNMP__set_replace_newer);
        newXS_deffile("SNMP::_set_save_descriptions", XS_SNMP__set_save_descriptions);
        newXS_deffile("SNMP::_set_debugging", XS_SNMP__set_debugging);
        newXS_deffile("SNMP::_register_debug_tokens", XS_SNMP__register_debug_tokens);
        newXS_deffile("SNMP::_debug_internals", XS_SNMP__debug_internals);
        newXS_deffile("SNMP::_mib_toggle_options", XS_SNMP__mib_toggle_options);
        newXS_deffile("SNMP::_sock_cleanup", XS_SNMP__sock_cleanup);
        newXS_deffile("SNMP::_mainloop_finish", XS_SNMP__mainloop_finish);
        newXS_deffile("SNMP::_main_loop", XS_SNMP__main_loop);
        newXS_deffile("SNMP::_get_select_info", XS_SNMP__get_select_info);
        newXS_deffile("SNMP::_read_on_fd", XS_SNMP__read_on_fd);
        newXS_deffile("SNMP::_check_timeout", XS_SNMP__check_timeout);
        newXS_deffile("SNMP::MIB::NODE::TIEHASH", XS_SNMP__MIB__NODE_TIEHASH);
        newXS_deffile("SNMP::MIB::NODE::FETCH", XS_SNMP__MIB__NODE_FETCH);
        newXS_deffile("SnmpSessionPtr::DESTROY", XS_SnmpSessionPtr_DESTROY);
#if PERL_VERSION_LE(5, 21, 5)
